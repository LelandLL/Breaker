...
public class ShapesManager : MonoBehaviour
{
    ...
    private IEnumerator FindMatchesAndCollapse(RaycastHit2D hit2)
    {
        ...
        while (totalMatches.Count() >= Constants.MinimumMatches)
        {
            ...
            MoveAndAnimate(newCandyInfo.AlteredCandyInfo, maxDistance);
            MoveAndAnimate(collapsedCandyInfo.AlteredCandyInfo, maxDistance);
            ...
            totalMatches = shapes.GetMatches(collapsedCandyInfo.AlteredCandyInfo).
                Union(shapes.GetMatches(newCandyInfo.AlteredCandyInfo)).Distinct();
    ...
    private AlteredCandy CreateNewCandyInSpecificColumns(IEnumerable<int> columnsWithMissingCandy)
    {
        AlteredCandy newCandyInfo = new AlteredCandy();
