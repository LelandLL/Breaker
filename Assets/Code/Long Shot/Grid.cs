...
public class Grid : MHBaseClass {
    ...
    void Start()
    {
        ...
        eventBus.AddListener<Pointer.OnPointerFinished>(OnPointerFinished);
    ...
    void CreateGrid()
    {
        ...
        for (int x = 0; x < columns; x++)
        {
            ...
            for (int y = 0; y < rows; y++)
            {
                ...
                Grids[x, y] = elem.GetComponent<Selectable>().type;
    ...
    void OnPointerFinished(Pointer.OnPointerFinished data)
    {
        needsToAnimate = true;
    }
    ...
    void OnDestroy()
    {
        eventBus.RemoveListener<Pointer.OnPointerFinished>(OnPointerFinished);
    }
